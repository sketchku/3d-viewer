...
import { t, getLanguage } from './i18n.js?v=2.7.9';
import { initVisitorChat } from './visitor-chat.js?v=2.7.9';
...
import { createBgPixels, loadBgFromStorage } from './bg-pixels.js?v=2.7.9';
import { initViewportDock } from './viewport-dock.js?v=2.7.9';
