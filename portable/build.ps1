...
# Copy app files
$Include = @('index.html', 'app.js', 'i18n.js', 'i18n-boot.js', 'styles.css', 'bg-pixels.js', 'web-config.js', 'chat-config.js', 'chat-translate.js', 'visitor-chat.js', 'stl-loader.js', 'cad2d-loader.js', 'drawing-export.js', 'viewer-features.js', 'recent-files.js', 'part-tree.js', 'large-file-loader.js', 'rhino-loader.js', 'cad-format-guide.js', 'cad-step-convert.js')
